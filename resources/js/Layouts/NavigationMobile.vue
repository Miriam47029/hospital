<template>
  ...
  <transition
    ...
    <aside v-show="$page.props.showingMobileMenu" class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-red-700 md:hidden">
      <div class="py-4 text-white">
        ...
        <ul class="mt-6">
          ...
          <li class="relative px-6 py-3">
            ...
            <ul v-show="showingTwoLevelMenu" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-white rounded-md shadow-inner bg-red-900"
                aria-label="submenu">
              ...
              <li class="px-2 py-1 transition-colors duration-150 hover:text-white">
                <ResponsiveNavLink :href="route('pacientes.create')" :active="route().current('pacientes.create')">
                  Create
                </ResponsiveNavLink>
              </li>
            </ul>
